...
def main():
    print("Evaluation metrics t-SNE")
    eval_for_path(r"./resultsTSNe.npy")
    print("Evaluation metrics PCA")
    eval_for_path(r"./resultsPCA.npy")
    print("Evaluation metrics UMAP")
    eval_for_path(r"./resultsUMAP.npy")
